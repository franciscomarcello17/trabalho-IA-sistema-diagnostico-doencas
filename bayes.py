    ...
    messages = [
        {
            ...
            - Para questões médicas SEMPRE inclua a frase: "Este é apenas um parecer preliminar - o diagnóstico definitivo requer avaliação médica profissional" no final da resposta
